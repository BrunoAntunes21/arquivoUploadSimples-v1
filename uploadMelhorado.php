...
try{
    ...
    //verificação de arquivo executavel
    if(is_executable($_FILES["arquivo_up"]["tmp_name"]))
        throw new Exception("Arquivos executaveis não permitidos");
         //caminho do novo arquivo no servidor com detecção de arquivo
         //obtendo a extensão do arquivo
    $ext_arquivo=pathinfo($_FILES["arquivo_up"]["name"],PATHINFO_EXTENSION );

         //nome unico
         $nome_unico=uniqid("enviado_").".". $ext_arquivo;
        //caminho do novo arquivono servidor
